...
📦 **Download Plugin & Documentation**
  - Download the [Luxodd Arcade Unity Plugin](https://github.com/luxodd/unity-plugin)
...
Several other revenue strategies we have in development are outlined in our revenue [playbook](https://drive.google.com/file/d/1MMvjRvZvb6FtxUDF_4YmPJLDsmKf-ayL/view?usp=sharing).
