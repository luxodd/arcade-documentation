	...
	themeConfig: {
		...
		navbar: {
			...
			items: [
				...
				{
					to: `${LANDING_PAGE_URL}/purchase`,
					label: "Purchase",
					position: "left",
					target: "_self",
				},
				{
					to: `${LANDING_PAGE_URL}/resources`,
					label: "Resources",
					position: "left",
					target: "_self",
					items: [
						{
							label: 'Developer',
							href: `${LANDING_PAGE_URL}/developer`,
							className: 'submenu-item',
							target: "_self",
						},
						{
							label: 'Strategic Betting',
							href: `${LANDING_PAGE_URL}/strategic-betting`,
							className: 'submenu-item',
							target: "_self",
						},
						{
							label: 'Articles',
							href: `${LANDING_PAGE_URL}/articles`,
							className: 'submenu-item',
							target: "_self",
						},
					],
				...
				{
					to: `https://itch.io/jam/one-more-run-iii`,
					label: "Join Game Jam",
					position: "left",
					target: "_self",
				},
